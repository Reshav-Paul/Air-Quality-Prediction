# This module trains a GRU model for the prediction of SO2
...
X = data[['SO2', 'D-1 SO2', 'Air Temperature', 'Relative Humidity', 'Wind Speed']][:-1]
y = data[['SO2']][1:]
...
#fit the model
history = model.fit(X_train, y_train, validation_split = 0.1, epochs = 100, verbose = 0, batch_size = 28,
