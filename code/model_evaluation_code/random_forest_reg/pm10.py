#this module runs the random forest regression engine for PM10
...
colList = ['PM10', 'Day No.', 'Air Temperature', 'Dew Point Temperature', 'Year',
           'Pressure Station Level', 'Horizontal Visibility', 'Wind Speed']
target = ['PM10']
