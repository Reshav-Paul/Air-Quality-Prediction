...
class fetcher:
    def __init__(self, browser_path = 'undefined'):
        ...
        try:
            ...
            driver_path = root_path + '\\geckodriver.exe'
            if browser_path != 'undefined':
                options.binary_location = browser_path
    ...
    def get(self, target_date):
        ...
        text_field = driver.find_element_by_xpath('//*[@id="calender_archive"]')
       	...
       	driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[1]/div[2]/div[8]/div[1]/form/table/tbody/tr/td[5]/div').click()
       	time.sleep(0.3)
        ...
        data_dict['Wind Speed'] = [driver.find_element_by_xpath('/html/body/div[4]/div[2]/div[1]/div[2]/div[10]/div/div/div[7]/table/tbody/tr[2]/td[2]/div[1]').text]
