...
# and provides methods to load a saved model and get the PM10 prediction
...
class pm10_predictor:
    ...
    def get_multi_lin_prediction(self, data):
        ...
        model = joblib.load(self.root_path + '/saved_models/pm10/pm10_multi_lin_predictor.joblib')
    ...
    def get_poly_prediction(self, data):
        ...
        model = joblib.load(self.root_path + '/saved_models/pm10/pm10_poly_predictor.joblib')
    ...
    def get_random_forest_prediction(self, data):
        ...
        model = joblib.load(self.root_path + '/saved_models/pm10/pm10_forest_predictor.joblib')
        prediction = model.predict(X)
    ...
    def get_svr_prediction(self, data):
        ...
        x_scaler = joblib.load(self.root_path + '/saved_scalers/pm10/pm10_svr_xscaler.save')
        y_scaler = joblib.load(self.root_path + '/saved_scalers/pm10/pm10_svr_yscaler.save')
        X = x_scaler.transform(X)
        model = joblib.load(self.root_path + '/saved_models/pm10/pm10_svr_predictor.joblib')
        prediction = model.predict(X)
    ...
    def get_mlp_prediction(self, data):
        ...
        scaler = joblib.load(self.root_path + '/saved_scalers/pm10/pm10_mlp_scaler.save')
        X = scaler.transform(X)
        model = joblib.load(self.root_path + '/saved_models/pm10/pm10_MLP.joblib')
        prediction = model.predict(X)
    ...
    def get_wide_deep_prediction(self, data):
        ...
        deep_scaler = joblib.load(self.root_path + '/saved_scalers/pm10/pm10_wide_deep_deep_scaler.save')
        wide_scaler = joblib.load(self.root_path + '/saved_scalers/pm10/pm10_wide_deep_wide_scaler.save')
        
        X_deep = deep_scaler.transform(X_deep)
        X_wide = wide_scaler.transform(X_wide)
        
        model = keras.models.load_model(self.root_path + '/saved_models/pm10/pm10_wide_deep.h5')
    ...
    def get_lstm_prediction(self, data):
        ...
        scaler = joblib.load(self.root_path + '/saved_scalers/pm10/pm10_lstm_scaler.save')
        X = scaler.transform(X)
        model = keras.models.load_model(self.root_path + '/saved_models/pm10/pm10_LSTM.h5')
    ...
    def get_gru_prediction(self, data):
        ...
        scaler = joblib.load(self.root_path + '/saved_scalers/pm10/pm10_gru_scaler.save')
        X = scaler.transform(X)
        model = keras.models.load_model(self.root_path + '/saved_models/pm10/pm10_GRU.h5')
        X = np.reshape(X, (X.shape[0], 1, X.shape[1]))
